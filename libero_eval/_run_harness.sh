...
cd "${ROOT_DIR}"
case "${VARIANT}" in
  standard) LIBERO_ROOT="${ROOT_DIR}/third_party/LIBERO"; TASK_SUITE="${TASK_SUITE:-libero_spatial}" ;;
  plus) LIBERO_ROOT="${ROOT_DIR}/third_party/LIBERO-plus"; TASK_SUITE="${TASK_SUITE:-libero_spatial}" ;;
  pro) LIBERO_ROOT="${ROOT_DIR}/third_party/LIBERO-PRO"; TASK_SUITE="${TASK_SUITE:-libero_spatial_swap}" ;;
...
export PYTHONPATH="${HARNESS_DIR}:${LIBERO_ROOT}:${ROOT_DIR}:${PYTHONPATH:-}"
