...
class RpcFacade:
    ...
    def serve(
        ...
        *,
        ...
        from hy_harness.utils.daemon import watch_parent_death
        from hy_harness.utils.http_rpc import HttpRpcServer
        from hy_harness.utils.socket_rpc import SocketRpcServer
