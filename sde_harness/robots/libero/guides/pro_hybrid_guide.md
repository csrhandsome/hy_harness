...
|---|---|---|
| how launched | oracle-state run | `hy_harness/cli/main.py --libero-type pro` (or `LIBERO_TYPE=pro`); perception artifacts always dumped, coords withheld |
...
```bash
python hy_harness/cli/main.py --suite <suite> --task <n> --seed <k> \
    --libero-type pro --planner codebuddy --model hy_a3b
...
python hy_harness/cli/main.py --suite libero_spatial_swap --task <N> --seed 0 \
    --libero-type pro --planner codebuddy --model hy_a3b
```
